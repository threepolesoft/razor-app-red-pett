namespace ReDpett_API.Modal
{
    ...
    public class WrittenCommunication
    {
        ...
        public WrittenCommunication(string title, string suspectedDisease, string type, string att_FileName, string fType, string fSize, string fContent)
        {
            Report_Title = title;
    ...
    public class CommentsTab
    {
        ...
        public CommentsTab(string title, DateTime commentDate)
        {
            commentText = title;
